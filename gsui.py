...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.spinBoxBlueCam = QtWidgets.QSpinBox(self.centralwidget)
        self.spinBoxBlueCam.setGeometry(QtCore.QRect(410, 20, 61, 41))
        self.spinBoxBlueCam.setMaximum(255)
        self.spinBoxBlueCam.setProperty("value", 0)
        self.spinBoxBlueCam.setObjectName("spinBoxBlueCam")
